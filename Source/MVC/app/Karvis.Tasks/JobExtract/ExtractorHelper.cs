...
namespace Karvis.Tasks.JobExtract
{
    public class ExtractorHelper : IExtractorHelper
    {
        ...
        /// Loading them in first step helps to increase performance  //  Shaahin : I don't think so !  but I did as Mr.Mohebbi prefered .
        /// </summary>
        ...
        public ExtractorHelper(  IKarvisCrawler karvisCrawler, IJobTask jobTask)
        {
        ...
        public void GetReady(AdSource siteSource)
        {
            ...
            preUrls = _jobTask.GetJobUrlsByAdSource(siteSource);
            preIgnoredUrlJobs = _jobTask.GetIgnoredUrls(siteSource);
        }
